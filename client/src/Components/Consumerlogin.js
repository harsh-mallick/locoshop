  ...
  return (
    <>
      {interval ? (<Loadingpage />) : (
        <section>
          <div className='h1login'>Customer Login</div>
          <div className="conntainer">
            <div className="mains">
              <div className="heading">Customer Login</div>
              <div className="subheading">Login to your Customer page!</div>
              <div className="forms">
                <form action="">
                  ...
                  <div className="notregister">Not Registered yet? <div className="create">&nbsp;Create a Customer Account</div></div>
                </form>
              </div>
            </div>
